...
class Sidebar extends Component {
  ...
  getNavItems(object, navItems) {
      navItems.items.map(function (item) {
          item.name = t(object).menu[item.nameLang]
          return item
      })

      console.log('NAV', navItems.items);
    ...
    return (
      <div className="sidebar">
        ...
        <nav className="sidebar-nav">
          <Nav>
            {navList(this.getNavItems(this, nav))}
          </Nav>
        </nav>
        <SidebarFooter/>
        <SidebarMinimizer/>
